          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide max-w-lg">
              ...
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="flex grow">
                  <div className="w-full h-full bg-gray-900 bg-opacity-80 from-gray-900 p-10">
                    <p className="text-xs font-bold leading-relaxed md:text-lg inline-flex text-white mx-auto self-center">Discover a seamless trucking experience with our platform. Register and create an account to access a world of loads waiting for you. Effortlessly find and book shipments, optimize routes, and track deliveries in real-time. Our user-friendly dashboard and mobile app keep you in control at every turn. Sign up now and take your trucking journey to new heights!</p>
                  </div>
                </div>
                <div className="absolute bottom-0 right-0 p-6">
                  <button type="button" onClick={(e) => {e.preventDefault(); e.stopPropagation(); setVideoModalOpen(true); }} className="text-xs font-medium text-center text-white py-2 px-3 rounded-full bg-teal-500  bg-opacity-50 hover:bg-opacity-100 transition duration-150 ease-in-out">Get started</button>
            ...
            <div className="swiper-slide max-w-lg">
              ...
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="flex grow">
                  <div className="w-full h-full bg-gray-900 bg-opacity-80 from-gray-900 p-10">
                    <p className="text-xs font-bold leading-relaxed md:text-lg inline-flex text-white mx-auto self-center">Welcome to a platform built for shippers like you. Simplify the way you ship goods with our user-friendly registration and account creation. Publish loads and connect with reliable carriers instantly. Enjoy the ease of live monitoring, tracking your shipments in real-time from pickup to delivery. Our intuitive dashboard and mobile app make managing your loads a breeze. Experience efficient shipping like never before</p>
                  </div>
                </div>
                <div className="absolute bottom-0 right-0 p-6">
                  <button type="button" onClick={(e) => {e.preventDefault(); e.stopPropagation(); setVideoModalOpen(true); }} className="text-xs font-medium text-center text-white py-2 px-3 rounded-full bg-teal-500 bg-opacity-50 hover:bg-opacity-100 transition duration-150 ease-in-out">Get started</button>
