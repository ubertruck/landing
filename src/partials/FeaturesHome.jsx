...
import TopImage from '../images/downloads/main_1.jpg';
import FeaturesBg01 from '../images/downloads/main_1.jpg';
import FeaturesElement01 from '../images/downloads/main_2.jpg';
import FeaturesElement02 from '../images/downloads/main_10.jpg';
import FeaturesElement03 from '../images/downloads/main_5.jpg';
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                <h3 className="h3 dark:text-gray-900 mb-3">Efficient tools for streamlined operations</h3>
                <p className="text-xl text-gray-600">Our platform offers innovative features and functionalities that enable you to optimize processes, increase productivity, and simplify logistics management.</p>
              </div>
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold dark:text-gray-600 leading-snug tracking-tight mb-1">Empowering Truck Drivers with a Seamless Ecosystem</div>
                    <div className="text-gray-600">Elevate your trucking experience with our platform tailored to meet the unique needs of truck drivers.</div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold dark:text-gray-600 leading-snug tracking-tight mb-1">Empowering Shippers with a Seamless Ecosystem</div>
                    <div className="text-gray-600">Take your shipping operations to the next level with our platform designed to enhance collaboration and efficiency.</div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold dark:text-gray-600 leading-snug tracking-tight mb-1">Discover the Simple Ecosystem</div>
                    <div className="text-gray-600">Experience seamless collaboration and enhanced productivity with our platform tailored for customers like you.</div>
                  </div>
              ...
              <div className="relative flex flex-col text-center lg:text-right">
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img className="md:max-w-none mx-auto rounded sm:mt-40" src={FeaturesBg01} width="500" height="375" alt="Features bg" />
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img className="md:max-w-none mx-auto rounded sm:mt-40" src={FeaturesElement01} width="500" height="375" alt="Features bg" />
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img className="md:max-w-none mx-auto rounded sm:mt-40" src={FeaturesElement02} width="500" height="375" alt="Features bg" />
                    {/*<img className="md:max-w-none absolute w-full left-0 transform animate-float" src={FeaturesElement01} width="500" height="147" alt="Element 01" style={{ top: '22%' }} />*/}
                    {/*<img className="md:max-w-none absolute w-full left-0 transform animate-float animation-delay-500" src={FeaturesElement02} width="500" height="158" alt="Element 02" style={{ top: '39%' }} />*/}
                    {/*<img className="md:max-w-none absolute w-full left-0 bottom-0 transform animate-float animation-delay-1000" src={FeaturesElement03} width="500" height="167" alt="Element 03" style={{ top: '77%' }} />*/}
                  </div>
