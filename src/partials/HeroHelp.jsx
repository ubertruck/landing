      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400" data-aos="fade-down" data-aos-delay="150">Discover solutions and support. Explore our knowledge base for articles, tutorials, and FAQs. Need assistance? Contact our team for prompt help. We value your feedback. Choose Cargocode for reliable support.</p>
