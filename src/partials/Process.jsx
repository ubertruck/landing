...
import MockupImage02 from '../images/downloads/main_1.jpg';
import MockupImage03 from '../images/downloads/main_2.jpg';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <section>
              <h2 className="h2 font-red-hat-display mb-4">Explore our user-friendly mobile app</h2>
              <p className="text-xl text-gray-600 dark:text-gray-400">Experience a seamless and intuitive mobile app designed for truck drivers. From booking loads to real-time shipment tracking, our app ensures unmatched convenience and efficiency. Join our growing community of satisfied users and elevate your transportation journey.</p>
          ...
          <div className="max-w-sm mx-auto grid gap-12 md:gap-x-6 lg:gap-x-12 md:grid-cols-3 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="inline-flex relative justify-center items-center">
                ...
                {/*<img className="absolute" src={MockupImage02} width="290" height="624" style={{ maxWidth: '84.33%' }} alt="App screen 02" />*/}
                {/* iPhone mockup */}
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="inline-flex relative justify-center items-center">
                {/* Image inside mockup size: 290x624px (or 580x1248px for Retina devices) */}
                {/*<img className="absolute" src={MockupImage03} width="290" height="624" style={{ maxWidth: '84.33%' }} alt="App screen 03" />*/}
                {/* iPhone mockup */}
                <img className="relative max-w-full mx-auto h-auto pointer-events-none" src={IphoneMockup} width="344" height="674" alt="iPhone mockup" aria-hidden="true" />
              </div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="inline-flex relative justify-center items-center">
                {/* Image inside mockup size: 290x624px (or 580x1248px for Retina devices) */}
                {/*<img className="absolute" src={MockupImage04} width="290" height="624" style={{ maxWidth: '84.33%' }} alt="App screen 04" />*/}
                {/* iPhone mockup */}
                <img className="relative max-w-full mx-auto h-auto pointer-events-none" src={IphoneMockup} width="344" height="674" alt="iPhone mockup" aria-hidden="true" />
              </div>
            </div>
