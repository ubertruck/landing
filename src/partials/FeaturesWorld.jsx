...
import PlanetImage from '../images/planet/planet.png';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Seamless expansion for efficient transportation</h1>
            <p className="text-xl text-gray-600">Unlock new opportunities and extend your trucking operations globally with our platform designed for international shipping, simplifying cross-border logistics.</p>
          </div>
