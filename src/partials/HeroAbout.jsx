...
import HeroBg from '../images/downloads/main_1.jpg';
import HeroImage from '../images/downloads/main_7.jpg';
          ...
          <div className="text-center">
            <div className="relative flex justify-center items-center">
              ...
              <div className="absolute" data-aos="fade-down">
                <h1 className="h1 lg:text-6xl font-red-hat-display">Discover your own <span className="text-teal-500">way</span></h1>
              </div>
